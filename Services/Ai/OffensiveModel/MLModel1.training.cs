...
using Microsoft.ML;
using static MLModel2_ConsoleApp2.MLModel2;

namespace MLModel1_ConsoleApp2
{
    public partial class MLModel2
    {
        public const string RetrainFilePath = @"C:\Users\quinn\Downloads\archive (4)\labeled_data.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName: @"tweet", outputColumnName: @"tweet")
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options() { L1Regularization = 0.1119367F, L2Regularization = 0.06376354F, LabelColumnName = @"class", FeatureColumnName = @"Features" }))
